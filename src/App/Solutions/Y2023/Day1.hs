...
part1 inputStr = Just $ sumOfAllLinesValues $ lines inputStr


part2 :: [Char] -> Maybe Int
part2 inputStr = Just $ sumOfAllLinesValues $ map convertDigitsToLetters $ lines inputStr
